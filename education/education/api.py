...
def get_ai_conversations(status=None, limit=20):
    ...
    from education.education.doctype.ai_conversation.ai_conversation import \
...
def get_conversation_messages(conversation_name, limit=50):
    ...
    from education.education.doctype.ai_message.ai_message import \
...
def get_current_enrollment(student, academic_year=None):
    current_academic_year = (
        academic_year or frappe.defaults.get_defaults().academic_year
    )
