    ...
    for student in result_dict:
        ...
        for criteria in assessment_criteria_dict:
            ...
            if criteria in result_dict[student][args.course][args.assessment_group]:
                ...
                student_row[scrub_criteria + "_score"] = result_dict[student][
                    args.course
                ][args.assessment_group][criteria]["score"]
...
def get_formatted_result(
    ...
    get_course=False,
    get_all_assessment_groups=False,
):
    ...
    if not (
        len(assessment_groups) == 1 and assessment_groups[0] == args.assessment_group
    ):
    ...
    for result in assessment_result:
        ...
        # create the total of all the assessment groups criteria-wise
            ...
            if not formatted_assessment_result[result.student][result.course][
                ...
                result.assessment_criteria
                in formatted_assessment_result[result.student][result.course][
                    args.assessment_group
                ]
            ):
        ...
        total_maximum_score = formatted_assessment_result[result.student][
            result.course
        ][args.assessment_group]["Final Grade"]["maximum_score"]
        if get_assessment_criteria:
            assessment_criteria_dict[
                result.assessment_criteria
            ] = formatted_assessment_result[result.student][result.course][
                args.assessment_group
            ][
