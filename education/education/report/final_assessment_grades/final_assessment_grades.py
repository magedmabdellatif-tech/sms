        ...
        if student_details.get(student):
            ...
            for course in course_dict:
                ...
                if assessment_group in assessment_result[student][course]:
                    student_row["grade_" + scrub_course] = assessment_result[student][
                        course
                    ][assessment_group]["Total Score"]["grade"]
                    student_row["score_" + scrub_course] = assessment_result[student][
                        course
                    ][assessment_group]["Total Score"]["score"]
                    ...
                    if (
                        student_row["grade_" + scrub_course]
                        not in course_wise_analysis[course]
                    ):
                        course_wise_analysis[course][
                            student_row["grade_" + scrub_course]
                        ] = 1
                    else:
                        course_wise_analysis[course][
